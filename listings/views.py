...
def search(request):
        ...
        if 'keywords' in request.GET:
             ...
             if keywords:
                  queryset_list = queryset_list.filter (Q(description_icontains=keywords) | Q(title_icontains=keywords) | Q(doctor__name__icontains=keywords))
